...
#===================================================================
program = "HESFLV1 ResNet18 on HAM10000"
...
def FedAvg(w):
    ...
    for k in w_avg.keys():
        # print('w_avg.keys', k)
        #print('check1')
        #print('w_avg[k]',w_avg[k])
        for i in range(1, len(w)):
            #print('check2')
            #print('w[i][k]',len,w[i][k])
            w_avg[k] += w[i][k]
        #print('check3')
        #print('w_avg[k]',w_avg[k])
...
# print(df['path'])
column_name_has_none = df['path'].isnull().any()

# 결과 출력
if column_name_has_none:
    print("특정 컬럼에 None 값이 있습니다.")
else:
    print("특정 컬럼에 None 값이 없습니다.")
